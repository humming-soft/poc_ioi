			...
			<div id="dashboard" class="col-md-12">
				...
				<div id="infographic" class="">
					<div class="ig_plate poipoi">
						...
						<?php include 'module/dboard_summary.php' ?>
...
<script type="text/javascript" src="../assets/js/page/dboard_summary.js"></script>
<link rel="stylesheet" type="text/css" href="../assets/css/page/summary.css">
